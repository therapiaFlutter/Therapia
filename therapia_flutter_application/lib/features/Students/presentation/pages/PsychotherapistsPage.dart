      ...
      body: Center(
        child: Container(
          ...
          child: ListView.builder(
            itemCount: _psychotherapist.length,
            itemBuilder: (BuildContext context, int index) {
              final therapist = _psychotherapist[index];
              return Container(
                height: 136,
                margin:
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Row(
                              ...
                              children: [
                                // Add SizedBox to create space between the text and the button
...
class Psychotherapist {
  ...
  Psychotherapist({
    required this.name,
    required this.image, // Update the type here as well
    required this.location,
  });
}

final List<Psychotherapist> _psychotherapist = [
  Psychotherapist(
    name: "sliemn labyedh",
    image: "lib/core/assets/images/psyImg.jpg", // Provide the image path as a string
